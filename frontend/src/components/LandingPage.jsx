...
const LandingPage = ({ onStartChat, onLogin, isLoggedIn }) => {
  return (
          ...
          {!isLoggedIn && (
            <>
              ...
              <button
                ...
                className="bg-gray-800 hover:bg-gray-700 text-white py-2 px-4 rounded-lg font-medium flex items-center justify-center"
              >
              ...
              <button
                ...
                className="bg-blue-700 hover:bg-blue-800 text-white py-2 px-4 rounded-lg font-medium flex items-center justify-center"
              >
